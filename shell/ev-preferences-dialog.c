...
/*
 * evince-preferences dialog is a singleton since we don't
 * want two dialogs showing an inconsistent state of the
 * preferences.
 * When ev_show_preferences_dialog is called and there
...
{
    dlg->toolbar_settings = g_settings_new ("org.x.reader.toolbar");

    gtk_window_set_title (GTK_WINDOW (dlg), _("Xreader Preferences"));
